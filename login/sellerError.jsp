<%-- 
    Document   : sellerError
    Created on : Jun 8, 2022, 1:03:56 PM
    Author     : User
--%>
        ...
        <div class="register-photo">
            <div class="form-container">
                <div class="image-holder">
                    ...
                    <form method="post" action="sellerLoginTask.jsp" style=" text-align: center">
                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12 login-title">
                        ...
                        <br>
                    <div>
                        <div class="form-group"><input class="form-control" type="text" name="sellerID" placeholder="Seller ID"></div>
                        <div class="form-group"><input class="form-control" type="password" name="sellerPw" placeholder="Password"></div><br>
