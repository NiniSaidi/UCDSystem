            ...
            <div class="form-container">
                <div class="image-holder">
                    ...
                    <div class="col-lg-12 login-title">
                        ...
                        <br>
                    <div>
                        <button class="button button1" onclick="window.location='<%=request.getContextPath()%>/login/sellerLogin.jsp'" type="button">SELLER</button>

                        <button class="button button1" onclick="window.location='<%=request.getContextPath()%>/login/buyerLogin.jsp'" type="button">BUYER</button>
                    </div>
                    <br>
                    <div class="col-lg-12 ">
                                    <div class="col-lg-6 ">
                                    ...
                                    <div>
                                        <p class="signup">Don't have an account? &nbsp;<a href="<%=request.getContextPath()%>/login/userForm.jsp" style="color: blue">Sign up</a></p>
                                    </div><hr>
                                    <div class="hr">
