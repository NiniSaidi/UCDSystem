<%-- 
    ...
    Created on : Jun 6, 2022, 12:31:14 PM
    Author     : User
--%>
               ...
               <div class="row">
                  ...
                  <div class="col-xl-9 col-lg-9 col-md-9 col-sm-9">
                    ...
                    <%
                         ...
                         Object sellerPhoneNo = session.getAttribute("sellerPhoneNo");
                         Object sellerEmail = session.getAttribute("sellerEmail");
                         Object sellerAddress = session.getAttribute("sellerAddress");
                         Object sellerPw = session.getAttribute("sellerPw");
                ...
                <div class="row">
                            <div class="col-xl-3 col-md-6 container py-5 text-center float-on-hover container1">
                                <div class="card bg-white text-white mb-4 mt-auto" style="width: 300px; padding: 10px ">
                                    <a href="<%=request.getContextPath()%>/sellerPanel/ibooking-form-new.jsp">
                            ...
                            <div class="col-xl-3 col-md-6 container py-5 text-center float-on-hover">
                                <div class="card bg-white text-white mb-4 mt-auto" style="width: 300px; padding: 10px ">
                                    <a href="<%=request.getContextPath()%>/sellerPanel/process-view-booking.jsp">
                            ...
                            <div class="col-xl-3 col-md-6 container py-5 text-center float-on-hover">
                                <div class="card bg-white text-white mb-4 mt-auto" style="width: 300px; padding: 10px ">
                                    <a href="<%=request.getContextPath()%>/sellerPanel/seller-view-profile.jsp">
