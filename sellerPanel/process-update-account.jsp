<%-- 
    ...
    Created on : Jun 24, 2022, 11:28:53 AM
    Author     : User
--%>
      ...
      <div id="contact" style="background-color: whitesmoke;width: auto; height: auto; background-image: url('<%=request.getContextPath()%>/resources/images/carstore.png')">
            <div style="padding: 10px; width: 60%; margin-left: auto; margin-right: auto">
                ...
                <div class="container2 col-md-4" style="margin-left: auto; margin-right: auto"">
                 ...
                 <form name="viewprofile" class="form-group" id="tdbooking" action="process-update-account2.jsp" method="POST">
                    <fieldset style="padding: 15px">
                        ...
                        <table style="border-collapse:separate; border-spacing:0 15px;" class="center">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="sellerPhoneNo" id="sellerPhoneNo" value="<%=rs.getString("sellerPhoneNo") %>" ></td>
                                <td><label for="sellerEmail"><b>E-mail : </b></label></td>
                                <td><input type="text" name="sellerEmail" id="sellerEmail" value="<%=rs.getString("sellerEmail") %>" ></td>
                            </tr>
                            <tr>
                                <td><label for="sellerAddress"><b>Address : </b></label></td>
                                <td><input type="text" name="sellerAddress" id="sellerAddress" value="<%=rs.getString("sellerAddress") %>" ></td>
                                <td><label for="sellerPw"><b>Password : </b></label></td>
                                <td><input type="password" name="sellerPw" id="sellerPw" value="<%=rs.getString("sellerPw") %>" ></td>
                        ...
                        <button type="button" class="button button1" onclick="window.location='<%=request.getContextPath()%>/sellerPanel/seller-view-profile.jsp'">Cancel</button>
                        <br>
                        </div>
