<%-- 
    Document   : process-view-tdbooking2
    Created on : Jun 24, 2022, 10:47:37 PM
    Author     : User
--%>
        ...
        <div id="page-wrapper" >
            <div id="page-inner" style="width: 100%">
                <div class="row">
                        ...
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                            ...
                            <table style="margin-left: 10px; margin-bottom: 15px; width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 20%"><b>Form ID:</b> <%=rs.getInt("formID") %></td>
                                    <td style="width: 30%"><b>Buyer ID:</b> <%=rs.getString("buyerID") %></td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                </tr>
                                <tr>
                                    <td style="width: 30%"><b>Booking Date:</b> <%=rs.getString("bookingDate") %></td>
                                    <td style="width: 30%"><b>Car ID:</b> <%=rs.getString("carID") %></td>
                                    <td style="width: 30%"><b>Description:</b> <%=rs.getString("description") %></td>
                                </tr>
                            </table>
                        </fieldset>
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                    ...
                    <%}%>   
                    <div style="text-align: center">
                        <button type="button"><a href="process-update-tdbooking.jsp?formID=<%=formID%>" style=" text-decoration: none; color: black">Update Status</a></button>
                        <button type="button" onclick="window.location.href = 'process-view-tdbooking.jsp';return false;">Cancel</button>
                    </div>
