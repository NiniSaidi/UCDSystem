...
<%@page import="java.sql.*, com.UCDSystem.TestDriveBooking" %>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <hr />
              <%
            List <TestDriveBooking> alltdbooking = tdbookingDao.retrieveAllTestDriveBooking();
            ...
            out.println("</thead>");
            out.println("<tbody>");
            for (int i = 0; i < alltdbooking.size(); i++)
            {
                out.println("<tr>");
                out.println("<td>" + alltdbooking.get(i).getFormID() + "</td>");
                out.println("<td>" + alltdbooking.get(i).getBuyerID() + "</td>");
                out.println("<td>" + alltdbooking.get(i).getCarID() + "</td>");
                out.println("<td>" + alltdbooking.get(i).getBookingDate() + "</td>");
                out.println("<td>" + alltdbooking.get(i).getDescription() + "</td>");
                out.println("<td>" + alltdbooking.get(i).getBookingStatus() + "</td>");
                out.println("<td><a href=process-view-tdbooking2.jsp?formID="
                        + alltdbooking.get(i).getFormID() + ">View</a>"
                        + "|" + "<a href=process-update-tdbooking.jsp?formID="
                        + alltdbooking.get(i).getFormID() + ">Update</a>"
                        + "</td>");
                out.println("</tr>");
            }
