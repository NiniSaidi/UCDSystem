<%-- 
    Document   : process-update-ibooking
    Created on : Jun 24, 2022, 11:24:27 PM
    Author     : User
--%>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner" style="width: 100%">
                <div class="row">
                    <form name="ibooking" class="form-group" id="ibooking" action="process-update-ibooking2.jsp" method="POST">
                    <% while (rs.next()) {%>
                    <div class="col-md-12">
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                            ...
                            <table style="margin-left: 10px; margin-bottom: 15px; width: 100%">
                                ...
                                <tr>
                                    <td style="width: 20%"><b>Inspection ID:</b> <%=rs.getInt("inspectID") %>
                                        <input type="hidden" name="inspectID" value="<%=rs.getInt("inspectID")%>">
                                    </td>
                        ...
                        <fieldset>
                            ...
                            <div style="text-align: center">
                                ...
                                <button type="button" class="centered" onclick="plusDivs(-1)">&#10094;</button>
                                <button type="button" class="centered" onclick="plusDivs(1)">&#10095;</button>
                              </div>
                    ...
                    <div style="text-align: center">
                        ...
                        <button type="button" onclick="window.location.href = 'process-view-ibooking2.jsp';return false;">Cancel</button>
                    </div>
                    </form> 
                </div>
            </div>
