<%-- 
    Document   : process-view-buyer2
    Created on : Jun 22, 2022, 9:17:11 AM
    Author     : User
--%>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                            <legend>Buyer Data</legend>
                            <table style="margin-left: 10px; margin-bottom: 15px; width: 100%">
                                <tr>
                                    <td style="width: 30%"><b>Buyer ID:</b> <%=rs.getString("buyerID") %></td>
                                    <td style="width: 30%"><b>First Name:</b> <%=rs.getString("buyerFirstName") %></td>
                                    <td style="width: 30%"><b>Last Name:</b> <%=rs.getString("buyerLastName") %></td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                </tr>
                                <tr>
                                    <td><b>Phone No:</b> <%=rs.getString("buyerPhoneNo") %></td>
                                    <td><b>Email:</b> <%=rs.getString("buyerEmail") %></td>
                                    <td><b>Address</b> <%=rs.getString("buyerAddress") %></td>
                                </tr>
                            </table>
                        </fieldset>
                       <hr/>
                    ...
                    <div style="text-align: center">
                        <button type="button" onclick="window.location.href = 'process-view-buyer.jsp';return false;">Back</button>
                    </div>
