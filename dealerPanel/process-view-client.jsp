...
font-size: 16px;"> <fmt:formatDate type = "both" dateStyle = "medium" timeStyle = "medium" value = "${now}" /> &nbsp; <a href="<%=request.getContextPath()%>/login/dealerLogin.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <%
                         ...
                         if (dealerid!= null){
                            out.println("<p style='color:white'>Dealer ID: "+dealerid+"<br>");
        ...
        <div id="page-wrapper" >
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>View Customer List</h2>   
                        <h5>List of customer successfully registered the website. </h5>
                    </div>
                </div>              
            ...
            for (int i = 0; i < allBuyer.size(); i++)
            {
                ...
                out.println("<td><a href=process-view-client2.jsp?clientID="
                        + allBuyer.get(i).getBuyerID() + ">View</a>"
                        + "|" + "<a href=process-delete-client.jsp?clientID="
