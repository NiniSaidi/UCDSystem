<%-- 
    Document   : process-view-buyer
    Created on : Jun 22, 2022, 9:16:54 AM
    Author     : User
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.List"%>
<%@page import="java.sql.*, com.UCDSystem.Buyer" %>
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu" href="<%=request.getContextPath()%>/dealerPanel/process-view-buyer.jsp">Buyer Account List</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                 ...
                 <%
            List <Buyer> allBuyer = buyerDao.retrieveAllBuyer();
            ...
            for (int i = 0; i < allBuyer.size(); i++)
            {
                ...
                out.println("<tr>");
                out.println("<td>" + allBuyer.get(i).getBuyerID() + "</td>");
                out.println("<td>" + allBuyer.get(i).getBuyerFirstName() + "</td>");
                out.println("<td>" + allBuyer.get(i).getBuyerLastName() + "</td>");
                out.println("<td>" + allBuyer.get(i).getBuyerPhoneNo() + "</td>");
                out.println("<td>" + allBuyer.get(i).getBuyerEmail() + "</td>");
                out.println("<td>" + allBuyer.get(i).getBuyerAddress() + "</td>");
                out.println("<td><a href=process-view-buyer2.jsp?buyerID="
                        + allBuyer.get(i).getBuyerID() + ">View</a>"
                        + "|" + "<a href=process-delete-buyer.jsp?buyerID="
                        + allBuyer.get(i).getBuyerID() + " onclick=\"return confirm"
