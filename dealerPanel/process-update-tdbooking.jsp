<%-- 
    Document   : process-update-tdbooking
    Created on : Jun 25, 2022, 12:08:52 AM
    Author     : User
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.List" %>
<%@page import="java.sql.*, com.UCDSystem.Car, com.UCDSystem.TestDriveBooking, com.UCDSystem.DBConnection" %>
<jsp:useBean id="carDao" class="com.UCDSystem.CarDAO" scope="request"/>
<jsp:useBean id="tdbookingDao" class="com.UCDSystem.TestDriveBookingDAO" scope="request"/>
...
<%
        ...
        ResultSet rs = st.executeQuery("select * from testdrivebooking INNER JOIN car ON testdrivebooking.carID = car.carID where formID = '"+formID+"'");
    ...
    <div id="wrapper">
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a class="active-menu" href="<%=request.getContextPath()%>/dealerPanel/process-view-tdbooking.jsp">Test Drive Booking List</a>
                            </li>
                        </ul>
                    </li> 
        ...
        <div id="page-wrapper" >
            <div id="page-inner" style="width: 100%">
                ...
                <div class="row">
                    <form name="tdbooking" class="form-group" id="tdbooking" action="process-update-tdbooking2.jsp" method="POST">
                    <% while (rs.next()) {%>
                    <div class="col-md-12">
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                            <legend>Booking Information</legend>
                            <table style="margin-left: 10px; margin-bottom: 15px;margin-right: 10px; width: 90%">
                                <tr>
                                    <td style="width: 30%"><b>Booking Status:</b>
                                        <select name="bookingStatus" id="bookingStatus" class="form-control">
                                                    <option value="<%=rs.getString("bookingStatus") %>"><%=rs.getString("bookingStatus") %></option>
                                                    <option value="Pending">Pending</option>
                                                    <option value="Approved">Approved</option>
                                                    <option value="Completed">Completed</option>
                                        </select>
                                    </td>
                                    <td style="width: 30%;padding-left: 40px"><b>Form ID:</b> <%=rs.getInt("formID")%>
                                        <input type="hidden" name="formID" value="<%=rs.getInt("formID")%>">
                                    </td>
                                    <td style="width: 40%;padding-left: 40px"><b>Buyer ID:</b> <%=rs.getString("buyerID")%>
                                        <input type="hidden" name="buyerID" value="<%=rs.getString("buyerID")%>">
                                    </td>
                                </tr>
                                <tr>
                                    <td><br></td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%"><b>Booking Date:</b> <%=rs.getString("bookingDate") %>
                                        <input type="hidden" name="bookingDate" value="<%=rs.getString("bookingDate")%>">
                                    </td>
                                    <td style="width: 30%;padding-left: 40px"><b>Car ID:</b> <%=rs.getString("carID") %>
                                        <input type="hidden" name="carID" value="<%=rs.getString("carID")%>">
                                    </td>
                                    <td style="width: 40%;padding-left: 40px"><b>Description:</b> <%=rs.getString("description") %>
                        ...
                        <fieldset style="background-color: #eeeeee; padding-left: 10px">
                            ...
                            <table style="margin-left: 10px; margin-bottom: 15px; width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 40%"><b>Car Status:</b> <%=rs.getString("carStatus") %></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><b>Year:</b> <%=rs.getString("yearMade") %></td>
                                </tr>
                            </table>
                        </fieldset><hr/>
                        <fieldset>
                            ...
                            <div style="text-align: center">
                                <img class="mySlides centered" src="<%=request.getContextPath()%>/images/getImage.jsp?carID=<%=rs.getString("carID")%>" width='450px'/>
                                <img class="mySlides centered" src="<%=request.getContextPath()%>/images/getImage2.jsp?carID=<%=rs.getString("carID")%>" width='450px'/>
                                <img class="mySlides centered" src="<%=request.getContextPath()%>/images/getImage3.jsp?carID=<%=rs.getString("carID")%>" width='450px'/>
                                <img class="mySlides centered" src="<%=request.getContextPath()%>/images/getImage4.jsp?carID=<%=rs.getString("carID")%>" width='450px'/>
                                <img class="mySlides centered" src="<%=request.getContextPath()%>/images/getImage5.jsp?carID=<%=rs.getString("carID")%>" width='450px'/>
                    ...
                    <div style="text-align: center">
                        ...
                        <button type="button" onclick="window.location.href = 'process-view-tdbooking2.jsp';return false;">Cancel</button>
                    </div>
                    </form> 
                </div>
            </div>
