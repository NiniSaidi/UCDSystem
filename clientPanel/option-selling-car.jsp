...
<html lang="en">
    ...
    <body class="main-layout">
      ...
      <!-- sell car section -->
            <!-- bestCar -->
      <div id="contact" style="background-color: #002752">
         <div class="">
            <div class="row">
               <div class="col-md-8">
               </div>
            ...
            <div class="col-md-6 offset-md-6" style="margin: auto">
                <form class="main_form multi text-center">
                    <div class="" style="padding-top: 10px; padding-bottom: 10px">
                        <h6><strong class="multi" style="color: black; font-size: 30px">Interested to sell your car?</strong></h6>
                    </div>
                    <div>
                        <h5>Request for a free inspection now! Click the button below to book for an inspection date.</h5>
                            <div class="sign_btn" style="text-align: center"><a href="<%=request.getContextPath()%>/clientPanel/booking-inspection-form.jsp">Book Now!</a></div>
                    </div>
                </form>
            </div><br><br>
        </div>
