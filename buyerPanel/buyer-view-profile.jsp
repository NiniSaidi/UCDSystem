<%-- 
    Document   : buyer-view-profile
    Created on : Jun 12, 2022, 9:04:56 AM
    Author     : User
--%>
      ...
      <div id="contact" style="background-color: whitesmoke;width: auto; height: auto; background-image: url('<%=request.getContextPath()%>/resources/images/carstore.png')">
            <div style="padding: 10px; width: 60%; margin-left: auto; margin-right: auto">
                ...
                <div class="container2 col-md-4" style="margin-left: auto; margin-right: auto"">
                 ...
                 <form name="viewprofile" class="form-group" id="viewprofile" action="process-update-account.jsp" method="POST">
                    <fieldset style="padding: 15px">
                        ...
                        <table style="border-collapse:separate; border-spacing:0 15px;" class="center">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="buyerPhoneNo" id="buyerPhoneNo" value="<%=rs.getString("buyerPhoneNo") %>" readonly></td>
                                <td><label for="buyerEmail"><b>E-mail : </b></label></td>
                                <td><input type="text" name="buyerEmail" id="buyerEmail" value="<%=rs.getString("buyerEmail") %>" readonly></td>
                            </tr>
                            <tr>
                                <td><label for="buyerAddress"><b>Address : </b></label></td>
                                <td><input type="text" name="buyerAddress" id="sellerAddress" value="<%=rs.getString("buyerAddress") %>" readonly></td>
                                <td><label for="buyerPw"><b>Password : </b></label></td>
                                <td><input type="password" name="buyerPw" id="sellerPw" value="<%=rs.getString("buyerPw") %>" readonly></td>
                            </tr>
                        </table>
                            <%}%>
                        <div style=" text-align: center">
                            <button type="submit" class="button button1">Update</button>
                        <button type="button" class="button button1" onclick="window.location='<%=request.getContextPath()%>/buyerPanel/buyerDashboard.jsp'">Cancel</button>
                        <br>
                        </div>
